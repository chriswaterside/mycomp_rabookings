...
<div class="eventsetting-edit front-end-edit">
    ...
    <?php else : ?>
        ...
        <form id="form-eventsetting"
            ...
            echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'eventsrestriction'));
            echo HTMLHelper::_('uitab.addTab', 'myTab', 'eventsrestriction', Text::_('COM_RA_EVENTBOOKING_TAB_EVENTSRESTRICTION', true));
            echo $this->form->renderField('created_by');
            echo $this->form->renderField('event_id');
            echo $this->form->renderField('booking_contact_id');
            echo $this->form->renderField('max_places');
            echo $this->form->renderField('payment_required');
            echo $this->form->renderField('payment_details');
            //  echo $this->form->renderField('creation_date');
